...
function Question() {
  ...
  const trends = ['Why is my angel so precious?', 'Why does Lichi love Bina more?', `How to be able to stare at her eyes?`,'Why my girlfriend always say "gataw" to me?', 'Why am I so lucky that I got to know Bina?']
       ...
       <div
        ...
        <div className="flex flex-col min-h-screen w-full max-w-[480px] mx-auto ">
          ...
          <div className='mt-10  px-5 text-white/50'>
            <p>Pro tip for my lovely angel: try searching "How long have we been together?" </p>
          </div>
        </div>
      )}
    </div>
